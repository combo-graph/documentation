...
Add UE 5.8 compatibility update

**Full Changelog**: <https://github.com/combo-graph/combo-graph/compare/1.6.1...1.6.2>
...
*   Add helper to support FVector2D/FVector2f compatibility for engine versions in [#62](./pull/62)
