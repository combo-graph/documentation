...
This page will describe the typical usage of three of those systems, and how they can be used along with Combo Graph plugin.
...
- Did it Hit: https://www.unrealengine.com/marketplace/en-US/product/did-it-hit-plugin
...
The last required step for the setup of the Collision Mesh, as explained in [Combat Components' documentation](https://ue4dcs.com/combatcomponents/collisionhandler/overview), is so define and place some sockets on the colliding component.
...
### Send Hit information to Combo Graph Abilities
...
- Target (usually self): The actor receiving the hit
