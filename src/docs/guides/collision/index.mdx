...
> **Note** If you'd like your mesh to collide with other objects than Character's Skeletal Meshsed (for instance the environment such as walls), you can adjust the settings here for the various preset and set the `AGR_Collision`
