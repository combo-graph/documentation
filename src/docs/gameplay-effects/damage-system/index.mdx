...
description: Combo nodes provide helpers to apply a list of "Damage Containers" to apply to targets in what is commonly called Gameplay Effect Containers
---

Combo nodes provide helpers to apply a list of "Damage Containers" to apply to targets in what is commonly called Gameplay Effect Containers.
