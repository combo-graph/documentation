...
- [Gameplay Cues (SFX / VFX Hit Impacts)](/usage/gameplay-cues) to learn more how you can apply sound and visual effects via gameplay cues for hit impacts.
